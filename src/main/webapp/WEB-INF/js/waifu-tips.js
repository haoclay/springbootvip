...
function showHitokoto(){
    $.getJSON('//api.fghrsh.net/hitokoto/rand/?encode=jsc&uid=3335',function(result){
        var text = '我超级喜欢 <span style="color:#0099cc;">『傻老婆』</span>啊!，这应该 <span style="color:#0099cc;">不会变吧!</span> 对呢！ {date} 记!';
...
var waifuJson = {
    ...
    "click": [
        {
            "selector": ".waifu #live2d",
            "text": ["傻老婆今天不乖啊", "哈哈哈,太喜欢你了怎么办?", "做我女朋友吧!", "再不答应我我就报警了！⌇●﹏●⌇", "110吗，这里有个小傻瓜一直不答应我做我女朋友(ó﹏ò｡)"]
        }
    ],
    "seasons": [
        {
